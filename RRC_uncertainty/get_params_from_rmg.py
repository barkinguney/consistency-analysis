...
out_dir_params = Path("RRC_uncertainty/results/arrhenius_params")
out_dir_rate_coeff = Path("RRC_uncertainty/results/rate_coefficients")
...
species_database = ET.parse("RRC_uncertainty/speciesDatabase.xml")
